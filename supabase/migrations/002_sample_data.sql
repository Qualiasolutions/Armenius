...
('call_sample_002', '+35799234567', 240, 'resolved', 'positive', 0.42, 'el', ARRAY['getStoreInfo', 'bookAppointment']),
('call_sample_003', '+35799345678', 95, 'incomplete', 'neutral', 0.18, 'en', ARRAY['checkOrderStatus']),
('call_sample_004', '+35799456789', 320, 'resolved', 'positive', 0.55, 'el', ARRAY['checkInventory', 'getProductPrice', 'bookAppointment']),
('call_sample_005', '+35799567890', 150, 'resolved', 'neutral', 0.28, 'en', ARRAY['getStoreInfo']);
...
('+35799234567', 'Maria Konstantinou', 'consultation', '2024-01-25 14:30:00+02', 'confirmed', 'Custom gaming PC build discussion'),
('+35799345678', 'Andreas Pavlou', 'warranty_service', '2024-01-26 11:00:00+02', 'pending', 'Graphics card warranty claim'),
('+35799456789', 'Elena Dimitriou', 'custom_build', '2024-01-26 16:00:00+02', 'confirmed', 'High-end workstation assembly');
...
('cache_hit', '{"function": "getStoreInfo", "language": "el"}'),
('cost_optimization', '{"originalLength": 120, "optimizedLength": 95, "savings": 25}'),
('call_started', '{"customerNumber": "+35799123456", "language": "en"}'),
('function_execution', '{"functionName": "bookAppointment", "processingTime": 1200, "success": true}');